...
project = 'Kitch'  # Rename this to your own project name
author = 'Benoit Goethals'  # This will appear in the copyright
release = '1.0.0'
...
html_theme_options = {
    ...
    'navigation_depth': 4,  # This determines the number of levels in the left content menu
    'includehidden': True,
    'titles_only': False
}
